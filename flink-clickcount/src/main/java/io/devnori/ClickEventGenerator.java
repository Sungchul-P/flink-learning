...
import io.devnori.records.ClickEventSerializationSchema;
...
import static io.devnori.ClickEventCount.WINDOW_SIZE;
...
public class ClickEventGenerator {
    ...
    //this calculation is only accurate as long as pages.size() * EVENTS_PER_WINDOW divides the window size
