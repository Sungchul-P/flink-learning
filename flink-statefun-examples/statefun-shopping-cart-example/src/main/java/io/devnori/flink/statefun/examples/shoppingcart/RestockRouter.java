...
public class RestockRouter implements Router<ProtobufMessages.RestockItem> {
    @Override
    public void route(ProtobufMessages.RestockItem message, Downstream<ProtobufMessages.RestockItem> downstream) {
