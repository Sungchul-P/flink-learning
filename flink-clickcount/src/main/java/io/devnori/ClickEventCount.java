...
import io.devnori.functions.BackpressureMap;
import io.devnori.functions.ClickEventStatisticsCollector;
import io.devnori.functions.CountingAggregator;
import io.devnori.records.ClickEvent;
import io.devnori.records.ClickEventDeserializationSchema;
import io.devnori.records.ClickEventStatistics;
import io.devnori.records.ClickEventStatisticsSerializationSchema;
...
public class ClickEventCount {
    ...
    private static void configureEnvironment(
        ...
        if (!enableChaining) {
            //diabling Operator chaining to make it easier to follow the Job in the WebUI
